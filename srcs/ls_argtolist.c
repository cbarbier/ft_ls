...
/*   Updated: 2017/02/17 14:18:01 by cbarbier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_ls.h"

static void	add_to_lists(t_ls *ls, t_lsarg *d)
{
	if ((d->fstat.st_mode & S_IFMT) == S_IFDIR)
	{
		...
		ft_lstpushback(&(ls->files), ft_lstnew(d, sizeof(t_lsarg)));
}
